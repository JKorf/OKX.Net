...
namespace OKX.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface IOKXUserClientProvider : IExchangeService
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, ApiCredentials credentials, OKXEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IOKXRestClient GetRestClient(string userIdentifier, ApiCredentials? credentials = null, OKXEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IOKXSocketClient GetSocketClient(string userIdentifier, ApiCredentials? credentials = null, OKXEnvironment? environment = null);
    }
}