namespace OKX.Net.Interfaces.Clients
{
    ...
    public interface IOKXUserClientProvider : IExchangeService
    {
        ...
        void InitializeUserClient(string userIdentifier, OKXCredentials credentials, OKXEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IOKXRestClient GetRestClient(string userIdentifier, OKXCredentials? credentials = null, OKXEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IOKXSocketClient GetSocketClient(string userIdentifier, OKXCredentials? credentials = null, OKXEnvironment? environment = null);
    }
}