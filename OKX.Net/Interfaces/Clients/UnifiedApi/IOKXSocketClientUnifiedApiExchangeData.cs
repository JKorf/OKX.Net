...
public interface IOKXSocketClientUnifiedApiExchangeData
{
    ...
    /// <param name="ct">Cancellation Token</param>
    /// <returns></returns>
    Task<CallResult<UpdateSubscription>> SubscribeToOpenInterestUpdatesAsync(string symbol, Action<DataEvent<IEnumerable<OKXOpenInterest>>> onData, CancellationToken ct = default);
    ...
    /// <param name="ct">Cancellation Token</param>
    /// <returns></returns>
    Task<CallResult<UpdateSubscription>> SubscribeToTickerUpdatesAsync(string symbol, Action<DataEvent<IEnumerable<OKXTicker>>> onData, CancellationToken ct = default);
