...
public enum FundingBillType
{
    ...
    Unknown327,
    [Map("328")]
    SendLiquidityStakingTokenReward,
    [Map("329")]
    SubscribeLiquidityStakingTokenStaking,
    [Map("330")]
    MintLiquidityStakingToken,    
    [Map("331")]
    RedeemLiquidityStakingTokenOrder,
    [Map("332")]
    SettleLiquidityStakingTokenOrder,
    [Map("333")]
    TrialFundReward,
    [Map("339")]
    OrderSubmission,
    ...
    OverduePenalty,
    [Map("348")]
    BtcStakingSubscription,
    [Map("349")]
    BtcStakingRedemption,
    [Map("350")]
    Earnings,
    [Map("351")]
    LoanDisbursement,
    ...
    AutoLendInterest,
    [Map("408")]
    AutoEarnUsdgInterest,
    [Map("476")]
    TransferredOutToCloudExchange,
    [Map("477")]
    TransferredInFromCloudExchange,
}
