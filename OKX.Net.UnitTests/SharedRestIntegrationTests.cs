...
namespace OKX.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IOKXRestClientUnifiedApiShared GetRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddOKX(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IOKXRestClient>().UnifiedApi.SharedClient;
        }
