...
namespace OKX.Net.UnitTests
{
    public class TestHelpers
    {
        ...
        public static IOKXRestClient CreateResponseClient(string response, Action<OKXRestOptions> options = null)
        {
            var client = (OKXRestClient)CreateClient(options);
            SetResponse(client, response);
            return client;
        }

        public static IOKXRestClient CreateResponseClient<T>(T response, Action<OKXRestOptions> options = null)
        {
            var client = (OKXRestClient)CreateClient(options);
