...
|File|Purpose|
|--|--|
|[`CLAUDE.md`](CLAUDE.md)|Assistant skill with core OKX.Net patterns, pitfalls, and examples|
...
GitHub Copilot and Cursor instructions are also provided in `.github/copilot-instructions.md` and `.cursor/rules/okx-net.mdc`; both point back to the root AI context files.
